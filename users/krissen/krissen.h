...
#define _____________________COLE_TH_L1_____________________ TO(_NAVIGATION), KC_LEFT, MT(MOD_LSFT, KC_TAB), LT(_SYMNUM, KC_SPC), KC_UP
...
#define _____________________COLE_TH_R1_____________________ KC_LEFT, TD(TD_TABC), KC_ENT, KC_RIGHT, TO(_QWERTY)
...
#define _____________________GAME_TH_L1_____________________ TO(_COLEMAK),  OSL(_NAVIGATION), KC_SPC,  KC_LALT,  KC_ENT
#define _____________________GAME_TH_L2_____________________ KC_TAB, KC_0
...
#define _____________________GAME_TH_R1_____________________ KC_F5,  KC_F8,  KC_F18,  KC_F17,  TO(_COLEMAK)
#define _____________________GAME_TH_R2_____________________ KC_F10,  KC_F12
