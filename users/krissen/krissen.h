...
#define _____________________COLE_TH_L1_____________________ KC_MEDIA_PLAY_PAUSE, KC_LEFT, LT(_SHORTCUT, KC_BSPC), MT(MOD_RSFT, KC_TAB), OSM(MOD_LSFT)
#define _____________________COLE_TH_L2_____________________ LT(_SYMBOLS, KC_ENT), OSL(_NUMNAV)
...
#define _____________________COLE_TH_R1_____________________ OSM(MOD_LSFT), MT(MOD_RSFT, KC_SPC), LT(_SHORTCUT, KC_DEL), KC_RIGHT, KC_MUTE
#define _____________________COLE_TH_R2_____________________ OSL(_NUMNAV), LT(_SYMBOLS, KC_ENT)
