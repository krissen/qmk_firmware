...
#define _____________________COLE_TH_L1_____________________ TO(_SHORTCUT), KC_LEFT, MT(MOD_LSFT, KC_TAB), LT(_SYMBOLS, KC_ENT), KC_BSPC
...
#define _____________________COLE_TH_R1_____________________ KC_BSPC, MT(MOD_RSFT, KC_SPC), LT(_SYMBOLS, KC_DEL), KC_RIGHT, TO(_QWERTY)
