...
#define _____________________COLE_TH_L1_____________________ TO(_NAVIGATION), KC_LEFT, MT(MOD_LSFT, KC_TAB), LT(_SYMNUM, KC_SPC), KC_BSPC
...
#define _____________________COLE_TH_R1_____________________ KC_DEL, KC_ENT, KC_BSPC, KC_RIGHT, TO(_QWERTY)
